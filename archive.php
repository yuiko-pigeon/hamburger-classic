...
<?php get_sidebar(); ?>
            <main class="l-main l-main__font">
                <div class="p-hero__imageArea">
                    ...
                    <img src="<?php echo get_theme_file_uri( './picture/three-burgers-on-brown-wooden-tray-between-white-ceramic-sp.webp' ); ?>" class="c-image__threeBurgers--sp" alt="3つのハンバーガー">
