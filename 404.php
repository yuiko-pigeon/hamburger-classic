...
<main class="l-main l-main__font">
                ...
                <article class="p-page404__text--area u-lineheight c-article p-page404__margin--bottom">
                    ...
                    <br>ブラウザの再読み込みを行ってもこのページが表示される場合は<span class="p-page404__text--sp">、</span><br class="p-page404__br--tb"><a href="<?php echo esc_url(home_url('/')); ?>" class="p-page404__link--bottom c-link">トップページ</a>から目的のページをお探しください。
                </article> 
</main>
<?php get_sidebar(); ?>
<?php get_footer(); ?>